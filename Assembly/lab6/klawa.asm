...
wyswietl_AL ENDP
;============================================================
; procedura obs³ugi przerwania klawiaturowego
...
; odczytanie zawartoœci wektora nr 9 i zapisanie go w pamiêci
...
; oczekiwanie na naciœniêcie klawisza
aktywne_oczekiwanie:
mov ah,1
int 16H
...
; deinstalacja procedury obs³ugi przerwania klawiatury
